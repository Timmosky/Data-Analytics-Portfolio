...
with Modelling:
    ...
    st.text('Instructions: Just enter the information of the client below and click predict to generate a result. Any unknown variable should be left as 0. No special characters such as commas or currency symbols.')
   
    model = pickle.load(open('C:/Users/timil/marketing_conversion_model.pkl', "rb"), encoding="latin1")
    ...
    def main():
        ...
        Campaign_Channel = st.selectbox('What campaign channel can you attribute this client to?', options = ['Social Media', 'Email', 'PPC', 'Referral', 'SEO', 'Others'])
